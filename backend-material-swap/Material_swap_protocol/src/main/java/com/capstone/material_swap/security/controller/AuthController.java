package com.capstone.material_swap.security.controller;
...
import com.capstone.material_swap.security.payload.JWTAuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<JWTAuthResponse> login(@RequestBody LoginDto loginDto){
        ...
        jwtAuthResponse.setUsername(loginDto.getPublicKey());
